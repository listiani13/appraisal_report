...
<script>
	...
	$(document).ready(function() {
		...
		$('#btnApprove').click(function(){
			$("#forApproval").append('<input type="hidden" name="approve" value="1">');
			$('#rejectReason').removeAttr('required');
			alert('Approve Success');
			
		});
		$('#btnReject.btnRejectRequest').click(function(){
			$("#forApproval").append('<input type="hidden" name="approve" value="0">');
			alert('Reject Success');
		});
		/*$('#navMilestone li.dropdown').on('click', function(event) {
