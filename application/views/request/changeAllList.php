			...
			<div class="page-content">
				...
				<div class="row container-fluid">
					<ul class="breadcrumb">
						...
						<li>
							<span><?php if ($from == 'change') echo 'Change'; else if ($from == 'pending') echo 'Pending'; else if ($from == 'history') echo 'History'; ?></span>
						</li>
					</ul>
				</div>
...
<script>
	...
	$(document).ready(function() {
		...
		else if(pending == 'pending')
		{
			...
			$('body').on('click', '.linkRequest', function() {
				window.location.href = "<?php echo base_url().'request/history?no='; ?>" + $(this).data('no');
			});
		}
