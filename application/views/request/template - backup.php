...
<div class="page-content-wrapper">
	<div class="page-content">
					...
					<div class="portlet-body">
						<div class="form-wizard">
							<ul id="navMilestone" class="nav nav-pills nav-justified steps">
								...
								?>
											<li <?php if (isset($approvalReq[$i])&&$milestone[$i]['code'] == $approvalReq[$i]['approval_code']&&$approvalReq[$i]['status']!="") echo ' class="active"'; ?>>
												<a class="step tooltips" data-html="true" data-original-title="<?php
													if (isset($approvalReq[$i])&&$milestone[$i]['code'] == $approvalReq[$i]['approval_code']&&$approvalReq[$i]['status']!=""){
														if($approvalReq[$i]['status'] == "1"){
															echo /*"Accepted by ".*/$approvalReq[$i]['name'];
														} else if($approvalReq[$i]['status'] == "0"){
															echo /*"Rejected by ".*/$approvalReq[$i]['name'];
														}
													} else {
														$flag = 1;
														$arrNama = [];
		...
		<form onsubmit="return validation()" enctype= "multipart/form-data" action="<?php 
			if($from == "create"){
		...
		?>" method="POST" id="form1">
								...
								<div class="form-body">
									<div class="row zrow">
										<div class="col-lg-6">
												...
												<select id="department" name="department" class="form-control">
													...
													<?php
														foreach ($all_department as $a) {
															...
															//else echo '<option class="'.$a->werks.'" value="'.$a->btrtl.'">'.$a->btrtl.' - '.$a->btext.'</option>';
														}
													} else {
														foreach ($all_department as $a) {
											...
											<div class="col-lg-8">
												<select id="direct_superior" name="direct_superior" class="form-control">
													<?php
													if(isset($genReq)){
										...
										<div class="col-lg-6">
											...
											<div class="col-lg-8">
												...
												?>
												<input readonly type="text" id="expected_working_date" name="expected_working_date" value="<?php echo $expected_working_date; ?>" class="form-control form-control-inline date-picker">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="row zrow">
										<div class="col-lg-6">
											...
											<div class="col-lg-8 replacement" <?php if ($reason != '1') echo 'style="display:none;"'; ?>>
												...
												<script>
												var all_employee = '<?php echo '<select name="nik[]" class="form-control">'; foreach ($all_employee as $a) echo '<option value="'.$a->pernr.'">'.$a->pernr.' - '.$a->name.'</option>'; echo '</select>'; ?>';
												</script>
											</div>
											<!--
											<div class="col-lg-12 gap">&nbsp;</div>
											...
											<div class="col-lg-12">
												<textarea style="height:180px;" readonly></textarea>
											</div>
											-->
										</div>
										<div class="col-lg-6">
											...
											<div class="col-lg-8">
												<table id="job_description" style="width:100%">
													<?php
													if($from == "change" || $from == "pending" || $from == "approvalPending" || $from == "history" || $from == "approvalHistory"){
													...
													?>
													<tr><td>
														<input accept=".jpg, .png, .PNG, .gif, .jpeg, .pdf, .doc, .docx, .xls, .xlsx, .ppt, .pptx" type="file" name="job_description[]" class="form-control"  id="job_description1">
													</td><td style="width:40px">
														<a class="btn btn-plus green"><i class="fa fa-plus"></i></a>
													</td></tr>
												</table>
											...
											<div class="col-lg-8">
												<table id="supporting_document" style="width:100%">
													<?php
													if($from == "change" || $from == "pending" || $from == "approvalPending"){
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-12">
												<?php
													//var_dump($eduBackReq);
												?>
												<table id="educational_background" style="width:100%">
													<tr>
											...
											<div class="col-lg-12">
												<table id="experience" style="width:100%">
													<tr class="sub"><td>
											...
											<div class="col-lg-12">
												...
												<div class="col-lg-10">
													<table id="other_qualification" style="width:100%">
														<tr>
											...
											<div class="col-lg-12">
												<label class="control-label col-lg-2 other_qualification">Other Qualification</label>
												<div class="col-lg-10">
													<table id="foreign_language" style="width:100%">
														<tr>
			...
			<div class="row">
				...
				<div id="forDelete"></div>
					...
					?>
						<button type="submit" name="btnApprove" class="btn green" id="btnApprove"><i class="fa fa-check"></i> Approve</button> 
							...
							<div class="modal-dialog">
								...
								<div class="modal-content">
									...
									<div class="modal-footer">
										<button type="submit" name="btnReject" class="btn red" id="btnReject"><i class="fa fa-times"></i> Reject</button> 
	...
	function validation() {
        ...
        $('input[name="job_description[]"]').each(function (i, val){
			if (val.value != '' && val.value.contains('.')) {
				...
				if(filesize < 10240000 && (ext =="png" || ext =="PNG" || ext =="jpg" || ext =="jpeg" || ext =="pdf" || ext =="doc" || ext =="docx" || ext =="xls" || ext =="xlsx" || ext =="ppt" || ext =="pptx" || ext =="gif" <?php if($from == "change" || $from == "approvalPending") echo '|| ext == ""';?>)){
					//benar
				}else{
					if(filesize >= 10240000) {
						alert("File size job description item "+ (i+1) + " must smaller than 10MB");
					}
					if(ext =="png" || ext =="PNG" || ext =="jpg" || ext =="jpeg" || ext =="pdf" || ext =="doc" || ext =="docx" || ext =="xls" || ext =="xlsx" || ext =="ppt" || ext =="pptx" || ext =="gif" <?php if($from == "change" || $from == "approvalPending") echo '|| ext == ""';?>){

					} else {
						alert("Check file type job description item "+ (i+1));
					}
					flag = false;
					//break;
				}
