									...
									<div class="row zrow">
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-6">
												...
												<div class="col-lg-12 gap">&nbsp;</div>
												<label class="control-label col-lg-4">NIK Superior 1</label>
												<div class="col-lg-8">
													<select class="form-control" id="nik_superior_1" name="nik_superior_1[]" multiple="multiple">
													</select>
												</div>
												<div class="col-lg-12 gap">&nbsp;</div>
												<label class="control-label col-lg-4">Name Superior 1</label>
												<div class="col-lg-8">
													<select class="form-control" id="name_superior_1" name="name_superior_1[]" multiple="multiple">
													</select>
												</div>
												<div class="col-lg-12 gap">&nbsp</div>
												<label class="control-label col-lg-4">Aopraisal Period</label>
												<div class="col-md-8">
											...
											<div class="col-lg-6">
												<div class="col-lg-12">
													<label class="control-label col-lg-4">NIK Superior 2</label>
													<div class="col-lg-8">
														<select class="form-control" id="nik_superior_2" name="nik_superior_2[]" multiple="multiple">
												...
												<div class="col-lg-12 gap">&nbsp;</div>
												<div class="col-lg-12">
													<label class="control-label col-lg-4">Name Superior 2</label>
													<div class="col-lg-8">
														<select class="form-control" id="name_superior_2" name="name_superior_2[]" multiple="multiple">
